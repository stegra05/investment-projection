...
export const CONFIRM_DELETE_ASSET_BUTTON = 'Delete Asset';
...
export const HEADING_PORTFOLIO_SETTINGS = 'Portfolio Settings';
...
export const EMPTY_PORTFOLIOS_LIST = 'No portfolios found.';

// AssetList specific texts
...
export const TEXT_NA = 'N/A'; // For Not Applicable
...
export const BUTTON_PROCESSING_PROJECTION = 'Processing...';

// PortfolioWorkspacePage specific texts
export const BREADCRUMB_DASHBOARD = 'Dashboard';
export const BREADCRUMB_PORTFOLIO_PREFIX = 'Portfolio'; // Used when name is loading
