...
@assets_bp.route('/', methods=['POST', 'OPTIONS']) # Route is relative to '/portfolios/<pid>/assets/'
@jwt_required()
...
@assets_bp.route('/<int:asset_id>/', methods=['PUT', 'PATCH', 'OPTIONS']) # Route is relative to '/portfolios/<pid>/assets/'
@jwt_required()
@verify_portfolio_ownership
...
@assets_bp.route('/<int:asset_id>/', methods=['DELETE', 'OPTIONS'])
@jwt_required()
@verify_portfolio_ownership
